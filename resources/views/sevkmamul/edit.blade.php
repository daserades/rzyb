...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Sevkiyat Mamul Güncelle') }}</div>
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('sevkmamul.update', $sevkmamul->id) }}">
                        @method('PATCH')
                        @csrf
                      <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name='firma_id' class="form-control  @error('firma_id') is-invalid @enderror">
                                            <option value="{{$sevkmamul->firma_id}}">{{$sevkmamul->firma->name}}</option>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name='firmatipi_id' class="form-control  @error('firmatipi_id') is-invalid @enderror">
                                            <option value="{{$sevkmamul->firmatipi_id}}">{{$sevkmamul->firmatipi->name}}</option>
                            ...
                            <div class="col-md-6">
                                <input id="irsaliyeno" type="text" class="form-control @error('irsaliyeno') is-invalid @enderror" name="irsaliyeno" required autocomplete="irsaliyeno" value="{{$sevkmamul->irsaliyeno}}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="trh" type="date" class="form-control @error('trh') is-invalid @enderror" name="trh" autocomplete="trh" value="{{$sevkmamul->trh}}" autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                     <textarea id="adres" type="text" class="form-control"  name="adres" autocomplete="adres" autofocus>{{$sevkmamul->adres}}
                                    </textarea>
                                    </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                     <textarea id="aciklama" type="text" class="form-control"  name="aciklama" autocomplete="aciklama" autofocus>{{$sevkmamul->aciklama}}
                                    </textarea>
                                    </div>
                        </div>
