    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('iplikboya.update', $iplikboya->id) }}">
                        @method('PATCH')
                        @csrf
                         <div class="card-body">
                    <form method="POST" action="{{ route('iplikboya.update', $iplikboya->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name='firma_id' class="form-control  @error('firma_id') is-invalid @enderror" >
                                    <option value="@isset($iplikboya->firma_id){{$iplikboya->firma_id}}@endisset">@isset($iplikboya->firma->name){{$iplikboya->firma->name}}@endisset</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name='order_id' class="form-control  @error('order_id') is-invalid @enderror" >
                                    <option value="@isset($iplikboya->order_id){{$iplikboya->order_id}}@endisset">@isset($iplikboya->order->order_no){{$iplikboya->order->order_no}}@endisset</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <textarea id="aciklama" type="text" class="form-control"  name="aciklama"  autocomplete="aciklama" autofocus>{{$iplikboya->aciklama}}
                               </textarea>
                           </div>
                       </div> 
