    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <div class="card-header" align="center">{{ __('Mamul KKForm Listesi') }}
                    <div class="col-md-2" ><a href="{{route('mamulkkform.create')}}" class="btn btn-xs btn-primary">Yeni</a>
                    </div>
                </div>
                <div class="card-body">
...
<script>
    $(function() {
        $('#table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('mamulkkformjs') }}',
            columns: [
            { data: 'order.order_no' ,"defaultContent": ""},
            { data: 'topno' , "defaultContent": ""},
            { data: 'brutmetre'},
            { data: 'metre'},
            { data: 'kumaseni'},
            { data: 'kg'},
