                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name='departman_tb_id' class="form-control  @error('departman_tb_id') is-invalid @enderror" required>
                                            <option value="@isset($personel->departman_tb_id){{$personel->departman_tb_id}}@endisset">@isset($personel->departman->name){{$personel->departman->name}}@endisset</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name='gorevlistesis_tb_id' class="form-control  @error('gorevlistesis_tb_id') is-invalid @enderror" required>
                                            <option value="@isset($personel->gorevlistesis_tb_id){{$personel->gorevlistesis_tb_id}}@endisset">@isset($personel->gorevlistesi->name){{$personel->gorevlistesi->name}}@endisset</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name='durums_tb_id' class="form-control @error('durums_tb_id') is-invalid @enderror" required>
                                            <option value="{{$personel->durums_tb_id}}">{{$personel->durum->name}}</option>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                            <label for="no" class="col-md-4 col-form-label text-md-right">{{ ('Kart No') }}</label>

                            <div class="col-md-6">
                                <input id="no" type="text" class="form-control @error('no') is-invalid @enderror" name="no"  autocomplete="no" value="{{$personel->no}}" autofocus>
