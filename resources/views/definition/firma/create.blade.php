                        ...
                        <form method="POST" action="{{ route('firma.store') }}">
                            @csrf
                             <div class="form-group row">
                                <label for="zarano" class="col-md-4 col-form-label text-md-right">{{ __('Bayzara Firma No') }}</label>

                                <div class="col-md-6">
                                    <input id="zarano" type="text" class="form-control @error('zarano') is-invalid @enderror" name="zarano" value="{{ old('zarano') }}" autocomplete="zarano" autofocus>
                           ...
                           <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name='yesno_id' class="form-control @error('yesno_id') is-invalid @enderror" required>
                                            <option value="">Seçiniz..</option>
