...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Ham KKForm Ekleme') }}</div>
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('kkformcreate1') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="barcode" class="col-md-4 col-form-label text-md-right">{{ __('Top No') }}</label>
