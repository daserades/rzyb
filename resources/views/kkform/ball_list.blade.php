...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-auto">
            <div class="card">
                <div class="card-header" align="center">{{ __('Top Listesi') }}
                </div>
                <div class="card-body">
...
<script>
  ...
  //var rowData = table.row( this ).data();
        ...
        table= $('#table').DataTable({
            ...
            //     //console.log(row);
            //     if (row.type != null) return '<a href="{{url('kkform/ballerror/')}}/'+data.id+'" target="_blank">'+row.type+'</a>';
            // } },
            ...
            { data: 'kg',"defaultContent": ""},
            { data: 'ebat',"defaultContent": ""},
            { data: 'trh',"defaultContent": ""},
